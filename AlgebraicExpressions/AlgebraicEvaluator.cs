...
{
    // TODO: Looks messy. Do the code cleanup later.
    public static class AlgebraicEvaluator
    {
        public static double EvaluateAlgebraicExpression(string expressionText)
        {
            var tokens = GetTokens(expressionText);
            ...
            return EvaluateExpressions(tokens, res);
        }

        static double EvaluateExpressions(List<Token> tokens, Dictionary<Token, List<Token>> expressionsOrder)
        {
            var tokensValue = tokens.Where(t => t.Type == TokenType.Operand)
                .ToDictionary(t => t.Id, t => double.Parse(t.Content));
            ...
            foreach (var expression in expressionsOrder)
            {
                ...
                // TODO: Fix it later. Looks like a shit.
            ...
            do
            {
                ...
                for (int i = 0; i < tokensMap.Count; i++)
                {
                        ...
                        && operators[currentOperatorsGroupIndex].Any(o => o.Equals(currentToken.Content)))
                    {
                        ...
                        // TODO: Add out of boundaries exeption handling.
                        ...
                        // TODO: Try to remove this variable.
                        shadowTokens.Add(shadowToken);
        ...
        static double EvaluateAlgebraicExpression(double left, double right, AlgebraicOperation operation)
        {
            switch (operation)
            {
